...
/**
 * Author: liasica
 * CreateTime: 16/4/29 14:50
 * Filename: XingeApp.php
...
class XingeApp
{
  ...
  {
    if (($this->accessId) >= XingeApp::IOS_MIN_ID and $message instanceof MessageIOS) return true;
    else if (($this->accessId) < XingeApp::IOS_MIN_ID and $message instanceof Message) return true;
    else
      return false;
  }
}